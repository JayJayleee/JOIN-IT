...
function MiniRecipeBox(props: any) {
  ...
  <div className='col doing-mini-recipe-box'>
    {props.posts.map((data: any) => (
      <div className={`row doing-recipe-box-detail ${props.selectTreatmentId === data.treatmentId? 'selected' : ''}`} key={data.treatmentId} onClick={(e) => {props.setTreatmentId(data.treatmentId)}}>
