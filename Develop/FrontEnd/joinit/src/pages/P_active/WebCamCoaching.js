...
import "./WebCamCoaching.css";

import { Pose, POSE_CONNECTIONS } from "@mediapipe/pose";
import { Camera } from "@mediapipe/camera_utils";
import { drawConnectors, drawLandmarks } from "@mediapipe/drawing_utils";

export default class WebCamCoaching extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    return (
      <div className="WebCamdiv2 col">
        ...
        <div className="WebCam_assistant col">
          <div
            className="WebCam_OnOff_Btn2"
            style={{cursor: 'pointer'}}
            onClick={() =>
              this.setState({ toggleSwith: !this.state.toggleSwith })
            }
          >
            모션 인식 ▶
          </div>
