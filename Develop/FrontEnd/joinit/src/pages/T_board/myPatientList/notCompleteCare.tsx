...
function NotCompleteCare({patient, eventChangeFtn, setPatientId}: propType) {
  ...
  return (
    <React.Fragment>
      <div className='row patientlist-detail notcomplete'>
        ...
        <div className='col patientlist-detail-text'>
          <div className='col patientlist-detail-text-title'>
            <p style={{fontWeight: 'bold', fontSize: '2.2rem'}}>{patient.name}</p>
          ...
          <div className='patientlist-detail-text-description'>
            <div className='patientlist-detail-button notcompleteBtn' onClick={(e) => {btnEventClick(e)}}>
              <p>프로필 보기</p>
            </div>
          </div>
        </div>
