...
--
-- Sequence structure for `log_login_seq`
--

DROP SEQUENCE IF EXISTS `log_login_seq`;
CREATE SEQUENCE `log_login_seq` start with 1 minvalue 1 maxvalue 9223372036854775806 increment by 50 cache 1000 nocycle ENGINE=InnoDB;
SELECT SETVAL(`log_login_seq`, 1, 0);
